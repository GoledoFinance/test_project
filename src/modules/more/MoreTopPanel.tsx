  ...
  return (
    <TopInfoPanel bridge={[]} pageTitle={<Trans>Protocol Owned DEX Liquidity Module</Trans>}>
      <Typography variant="description" maxWidth={685}>
        Sell GoledoCFX LP tokens directly to the protocol for a 10% premium
        <br />
        <br />
        50% of the CFX treasury rewards (earned from bottowing fees) are redifrected to purchase
