    ...
    addressParameters.forEach((storedParams) => {
      if (storedParams.field) {
        if (
          ...
          throw new Error(
            `Deadline: ${methodArguments[0][storedParams.field]} is bigger than 32 bytes`
          );
        }
      } else {
        ...
        if (
          ...
          throw new Error(
            `Deadline: ${methodArguments[storedParams.index]} is bigger than 32 bytes`
          );
        }
      }
    });
    ...
    addressParameters.forEach((storedParams) => {
      if (storedParams.field) {
        if (
          ...
          throw new Error(
            `Address: ${methodArguments[0][storedParams.field]} is not a valid ethereum Address`
          );
        }
      } else {
        const isOptional = isParamOptional?.[storedParams.index];
        if (
          ...
          throw new Error(
            `Address: ${methodArguments[storedParams.index]} is not a valid ethereum Address`
          );
        }
      }
    });
    ...
    amountParameters.forEach((storedParams) => {
      if (storedParams.field) {
        if (
          ...
          throw new Error(
            `Amount: ${methodArguments[0][storedParams.field]} needs to be greater than 0`
          );
        }
      } else {
        const isOptional = isParamOptional?.[storedParams.index];
        if (!isOptional && !(Number(methodArguments[storedParams.index]) > 0)) {
          throw new Error(
            `Amount: ${methodArguments[storedParams.index]} needs to be greater than 0`
          );
        }
      }
    });
    ...
    amountParameters.forEach((storedParams) => {
      if (storedParams.field) {
        if (
          ...
          throw new Error(
            `Amount: ${methodArguments[0][storedParams.field]} needs to be greater or equal than 0`
          );
        }
      } else {
        const isOptional = isParamOptional?.[storedParams.index];
        if (!isOptional && !(Number(methodArguments[storedParams.index]) >= 0)) {
          throw new Error(
            `Amount: ${methodArguments[storedParams.index]} needs to be greater or equal than 0`
          );
        }
      }
    });
    ...
    amountMinusOneParameters.forEach((storedParams) => {
      if (storedParams.field) {
        if (
          ...
          throw new Error(
            `Amount: ${methodArguments[0][storedParams.field]} needs to be greater than 0 or -1`
          );
        }
      } else {
        const isOptional = isParamOptional?.[storedParams.index];
        if (
          ...
          throw new Error(
            `Amount: ${methodArguments[storedParams.index]} needs to be greater than 0 or -1`
          );
        }
      }
    });
