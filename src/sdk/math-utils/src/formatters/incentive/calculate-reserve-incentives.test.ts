import { ReserveIncentiveMock, ReserveMock, UserReserveMock } from '../../mocks';
...
describe('calculateReserveIncentives', () => {
  const userReserveMock = new UserReserveMock().supply(100).variableBorrow(50).stableBorrow(50);
  const reserveMock = new ReserveMock().addLiquidity(100).addVariableDebt(50).addStableDebt(50);
            ...
            rewardsTokenInformation: [
              {
                ...
                rewardTokenAddress: '0x4da27a545c0c5b758a6ba100e3a049001de870f5', // To check stkAave -> mapping for v2 price feed
              },
            ],
          },
        },
